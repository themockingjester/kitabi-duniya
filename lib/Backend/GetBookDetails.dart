...
class GetBookDetails {
  ...
  Future<String> bookRatingCalculator(String bookAddress) async {
    String totalLikesInString =
        await GetBookDetails().getBookTotalLikes(bookAddress);
    if (totalLikesInString == 'failed' || totalLikesInString == 'not exist') {
      return 'NA';
    }
    int totalLikes = int.parse(totalLikesInString);
    String totalDislikesInString =
        await GetBookDetails().getBookTotalDisLikes(bookAddress);
    if (totalDislikesInString == 'failed' ||
        totalDislikesInString == 'not exist') {
      return 'NA';
    }
