...
class LoginPage extends StatefulWidget {
  bool wait = false;
  OutLineTextField emailOrPhone = OutLineTextField(
      Icons.email,
      'Email',
  ...
  Future<void> verifyDetailsForCurrentPage() async {
    if (widget.emailOrPhone.data != "") {
      if (widget.password.data != "") {
        ...
        widget.userCredential = await AuthFile().signInWithEmailandPassword(
            widget.emailOrPhone.data, widget.password.data, context);
        ...
        AppConstants()
            .defaultSnackBarForApp(context, "Enter a password first!");
      }
    } else {
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      ...
                      OutLineTextFieldForNormalEntry email =
                          OutLineTextFieldForNormalEntry("Email", "", "", "");
                          ...
                          ElevatedButton(
                            onPressed: () {
                              ...
                              AppConstants().defaultSnackBarForApp(
                                  context, "Resetting link has been sent!");
