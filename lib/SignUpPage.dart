...
class SignUpPage extends StatefulWidget {
  bool wait=false;
  OutLineTextField email = OutLineTextField(Icons.email, "Email",AppConstants().emailValidateRegexString,AppConstants().emailRegexErrorTextString);
  OutLineTextField name = OutLineTextField(Icons.person, "Full Name",AppConstants().personNameValidateRegexString,AppConstants().personNameRegexErrorTextString);
  String dob="";
  ...
  OutLineTextField retypePassword = OutLineTextField(Icons.vpn_key_outlined, "Retype Password",AppConstants().passwordValidateRegexString,AppConstants().passwordRegexErrorTextString);
  OutLineTextField phone = OutLineTextField(Icons.phone, "Your Phone Number",AppConstants().phoneNumberValidateRegexString,AppConstants().pincodeRegexErrorTextString);
