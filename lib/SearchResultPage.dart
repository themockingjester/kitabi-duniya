...
class _SearchResultPageState extends State<SearchResultPage> {
  List<SearchResultCard> tempListForAddingResultantBooks=[];

  Future<void> resultedBooksAdderFunction(card) async {

    tempListForAddingResultantBooks.add(card);
    // List<SearchResultCard> temp = List.from(widget.books);
    // temp.add(card);
    setState(() {
  ...
  Future<void> fetchTheData() async {
    ...
    String smallcaseString =
        await SearchEngine().covertAllToSmallerCase(widget.inputString);
