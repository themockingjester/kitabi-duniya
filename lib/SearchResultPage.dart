...
class _SearchResultPageState extends State<SearchResultPage> {
  ...
  Future<void> fetchTheData() async {
    Map addedBooks = Map();
    String removedSpecialCharacters = widget.inputString.replaceAll(".", "").replaceAll("#", "").replaceAll("[", "").replaceAll("]", "").replaceAll("\$", "");
    ...
    resultedBooksAdderFunction(Image(image: AssetImage("asset/image/flag.png")));
