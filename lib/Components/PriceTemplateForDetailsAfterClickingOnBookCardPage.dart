...
class PriceTemplateForDetailsAfterClickingOnBookCardPage
    extends StatelessWidget {
  ShowSpecificBookDetailAsynchronously bookMarketPrice;
  ShowSpecificBookDetailAsynchronously ourPriceForBook;

  PriceTemplateForDetailsAfterClickingOnBookCardPage(
      @required this.bookMarketPrice, @required this.ourPriceForBook);
