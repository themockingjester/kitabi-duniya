    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: ShowSpecificBookDetailAsynchronously(this.bookAddress,this.functionToCall,this.colorforvalue,16,FontWeight.normal,"",this.suffix,TextDecoration.none,context,""),
          ),
