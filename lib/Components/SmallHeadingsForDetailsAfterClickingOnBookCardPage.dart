...
class SmallHeadingsForDetailsAfterClickingOnBookCard extends StatefulWidget {
  ...
  @override
  _SmallHeadingsForDetailsAfterClickingOnBookCardState createState() =>
      _SmallHeadingsForDetailsAfterClickingOnBookCardState();
}

class _SmallHeadingsForDetailsAfterClickingOnBookCardState
    extends State<SmallHeadingsForDetailsAfterClickingOnBookCard> {
  @override
