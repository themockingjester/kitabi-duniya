...
class FileUploadPage extends StatefulWidget {
  ...
  OutLineTextFieldForBookOverView bookOverview = OutLineTextFieldForBookOverView("Enter Some details about this book");
  ...
  DropDown bookStatus =
      DropDown(AppConstants().acceptableBookConditions, AppConstants().acceptableBookConditions[0], "Book Status");
...
class _FileUploadPageState extends State<FileUploadPage> {
  Future<void> validateDetailsAndFurtherProcessing() async {
    if (RegExp(AppConstants().bookNameValidateRegexString)
                  ...
                  if(widget.bookOverview.data.length>10){
                    ...
                    if (await GetUserDetails().checkUserSuperiority() ==
                      ...
                      await SetBookDetails()
                          .addNewBook(context, widget.DirectTrigger, bookDetails);
                      setState(() {
                        widget.wait = false;
                      });
                    } else {
                    ...
                    AppConstants().defaultSnackBarForApp(context, "Enter some more book overview");
                  }
                } else {
      ...
      AppConstants().defaultSnackBarForApp(
          context, 'please enter a valid book name!');
    }
  }
